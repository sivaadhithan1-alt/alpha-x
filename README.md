...
![Hackathon](https://img.shields.io/badge/Hackathon-Hackspora%202.0-22d3ee)
![Problem Statement](https://img.shields.io/badge/PS3-ScamCheck-818cf8)
![Tests](https://img.shields.io/badge/Automated%20Checks-42%2F42%20passing-10b981)
...
| Member | Role |
|---|---|
| *(add names)* | *(e.g. Full-stack / ML / UI)* |

**Problem Statement 3 · Hackspora 2.0 · Built with ❤️ for student safety · MIT License**
```

## 📋 Before you commit — 3 quick edits

1. **Live Demo link** — confirm it's your latest production URL (or switch to the cleaner `scamcheck-alpha-x9.vercel.app` alias)
2. **Team table at the bottom** — replace *(add names)* with your actual teammates
3. Optional: take 2–3 screenshots of the app and add an `## 📸 Screenshots` section later (judges love it)

Paste → **Commit changes** → your repo looks instantly professional. 🏆
